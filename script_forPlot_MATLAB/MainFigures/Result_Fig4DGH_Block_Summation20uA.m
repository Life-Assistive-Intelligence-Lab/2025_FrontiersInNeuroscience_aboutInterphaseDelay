function Result_Fig4DGH_Block_Summation20uA
    ...
    Func_saveData_toCSV(dataBefore_forStatistical, dataName_forStatistical,'Fig4G_Block_Summation_20uABefore')

    dataAfter_forStatistical = dataAfter_forStatistical.';
    Func_saveData_toCSV(dataAfter_forStatistical, dataName_forStatistical,'Fig4H_Block_Summation_20uAAfter')
