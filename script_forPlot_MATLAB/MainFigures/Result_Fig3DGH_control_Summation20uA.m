function Result_Fig3DGH_control_Summation20uA
    ...
    Func_saveData_toCSV(dataBefore_forStatistical, dataName_forStatistical,'Fig3G_Control_Summation_20uABefore')

    dataAfter_forStatistical = dataAfter_forStatistical.';
    Func_saveData_toCSV(dataAfter_forStatistical, dataName_forStatistical,'Fig3H_Control_Summation_20uAAfter')
