function Result_Fig3JL_control_hew20uA
    ...
    for forEach_stim = 1:max(size(stim_list))
        ...
        xlim(-x([end 1]))
        ylim([-0.13 1.3]*nrmValue)
        yticks([0 round(nrmValue,-2)])
    ...
    Func_saveData_toCSV(data_forStatistical, dataName_forStatistical,'Fig3L_Control_hew_20uA')
